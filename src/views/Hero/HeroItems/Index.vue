...
const defaultItems = {
  head: { slotName: 'head' },
  shoulders: { slotName: 'Shoulders' },
  torso: { slotName: 'Torso' },
  neck: { slotName: 'Neck' },
  hands: { slotName: 'Hands' },
  waist: { slotName: 'Waist' },
  bracers: { slotName: 'Bracers' },
  leftFinger: { slotName: 'Left Finger' },
  legs: { slotName: 'Legs' },
  rightFinger: { slotName: 'Right Finger' },
  mainHand: { slotName: 'Main Hand' },
  feet: { slotName: 'Feet' },
  offHand: { slotName: 'Off Hand' },
}
